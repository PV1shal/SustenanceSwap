...
class TestReferencePlatform extends Mock
    with MockPlatformInterfaceMixin
    implements ReferencePlatform {
  TestReferencePlatform() : super();

  @override
  Future<String> getDownloadURL() {
    return super.noSuchMethod(Invocation.method(#getDownloadURL, []),
        returnValue: Future.value("$kBucket/$testName"),
        returnValueForMissingStub: Future.value("$kBucket/$testName"));
  }
}
...
class TestListResultPlatform extends Mock
    with MockPlatformInterfaceMixin
    implements ReferencePlatform {
  TestListResultPlatform() : super();
...
class TestTaskSnapshotPlatform extends Mock
    with MockPlatformInterfaceMixin
    implements TaskSnapshotPlatform {
  TestTaskSnapshotPlatform() : super();
...
class TestUploadTaskPlatform extends Mock
    with MockPlatformInterfaceMixin
  ...
  Future<TaskSnapshotPlatform> get onComplete {
    return super.noSuchMethod(Invocation.getter(#onComplete),
        returnValue: Future.value(TestTaskSnapshotPlatform()),
        returnValueForMissingStub: Future.value(TestTaskSnapshotPlatform()));
  }
}
